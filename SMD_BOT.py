...
def randomText_Mention():
    Words = [":v:" ,"🤔", "안녕하세요", "뭐해?", "😂", "💩", "👍", "👀", ":P", "👍", "Hello", "Hi!", "สวัสดี", "ดีจ้า", "How was your day", "ว่าไง?", "อะไร?", "ไม่สน", "อย่ามายุ่ง", "ลาก่อน", "Leave me alone!!!!", "สวย", "เริ่ดมาก", "เชิญห้องปกครอง", "อ๊อยหย๋อ", "ลาออก!", "ไม่อ่าน ไม่ตอบ ไม่สน...", ";w;", "=A=!", "- -*", "แล้วไง?"
            ,"https://giphy.com/gifs/sad-cry-capoo-3og0IG0skAiznZQLde", "https://giphy.com/stickers/cat-pearl-capoo-TFUhSMPFJG7fPAiLpQ", "https://giphy.com/gifs/happy-rainbow-capoo-XEgmzMLDhFQAga8umN", "https://giphy.com/gifs/cat-color-capoo-dYZxsY7JIMSy2Afy6e", "ระเบิดเวลา......**อ๊าาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาาา**", "เปล่าประโยชน์ เปล่าประโยชน์ เปล่าประโยชน์ เปล่าประโยชน์", "**How Dare You!!??**", "แหะ ๆ", "=[]=", "มั่ยน๊าาาาาาาาาาาาาา","หรอมมมมมม ๆ","ชั่ยชั่ยชั่ย","ทุกคนรู้ อาจารย์รู้ นักเรียนรู้ ดิฉันเป็นบอทค่ะ บอทแปลว่าอิสระ เพราะฉะนั้น ดิฉันจะไม่ยอมตกเป็นทาสของคุณหรอกค่ะ","สายหยุ--...อุ๊ย ไม่ใช่ ส้มหยุดดดดดดดดดดดดดดด","ม่ายยยยยยยยยยย","ช่ายยยยยยยยยยย","แต๊งกิ้วทีเชอร์","ซิทดาวพลีส","อาจารย์มาา!!","ห้ามนักเรียนนำอาหารและเครื่องดื่มขึ้นบนอาคารเรียน"
            ,"ห้ามนักเรียนสวมรองเท้าขึ้นบนอาคารเรียน","https://soundcloud.com/wearesmd/no-food?in=wearesmd/sets/sound","https://soundcloud.com/wearesmd/no-shoe?in=wearesmd/sets/sound","*เน๊าะลูกเน๊าะ* -- **วัชราภรณ์ ยืนชีวิต**","*เก่งแท้แม่ชื่ออะไร* -- **สำรวญ ชินจันทึก**","*มิตรภาพครับบบบบบบ มิตรภาพพพพพพ* -- **ไพทูล นารคร**", "*เธอไม่อินไง* -- **ศักดิ์สิทธิ์ หัสมินทร์**", "*เพราะชีวะ คือชีวิต* -- **นภาพรรณ เอี่ยมสำอางค์**", "OMG","มรีปัณหาร์อระไลห์หร่อส์","ขอเวลาอีกไม่นาน...","ขอเวลาอีกไม่นาน...*แค๊ก ๆ 6 ปีแล้ว*","แปป ๆ ไม่ว่าง","อุแงงงง","น้องบอทถูกใจสิ่งนี้","น้องบอทไม่ถูกใจสิ่งนี้","น้องบอทกดโกรธ :angry: สิ่งนี้","น้องบอทกดเลิฟ :love: สิ่งนี้","ถึงโควิดจะทำให้โรงเรียนปิด แต่ยังมีดิสไว้แก้คิดถึงกัน",":notes: โรงเรียนของเราน่าอยู่~",":notes: เด็กเอ๋ยเด็กดี~",":notes: มอดินแดง งามเด่นสวยเป็นสง่า~",":notes: ดั่งไม้ยืนต้น~",":notes: Let's kill บุรี่~!","นักเรียน 9xx มาเรียน 9-- แค๊ก ๆ มาเรียนครบบบบบบ!!","ฉันจะฉาปแก","มะงื้ออออออ","แต่ความจริงคื๊อ...... ดาวมีไว้เบิ่ง~~",":notes: จากอีสานบ้านนามาอยู่กรุง จากแดนทุ่งลายยยยยยยย~",":notes: เมืองหลวงควันและฝุ่นมากมาย *พิสูตร*ดมเข้าไปร่างกายก็เป็นภูมิแพ้","แทงปลาไหล 20 ยก!","SMD สวัสดีค่ะ","พิศหวงหวงหวงหวงหวงหวงหวงหวงหวงหวงหวงหวงหวง","พวกเรามาจาก...โรงเรียนสาธิตมหาวิทยาลัยขอนแก่น มอดินแดง [ออกเสียงแบบ SciShow นะ]", "**S TO THE A TO THE T I T TO THE SMD TO THE SMD... BOOM!**","นั่นสิ","อิหยังวะ","เฮ็ดหยังหนิสู","สูกะดาย", "อะไรกันครับเนี่ย!?", "อะไรกันครับเนี่ย ผมงงไปหมดแล้ว","10 คะแนนเต็ม 10 คะแนนเต็มมมมมมมมมมมม!","แมสหมดแล้วค่ะ","ปังไม่หยุด","ปังมากแม่","ปังมาก"]
